...
public class Child extends Person {
	...
	public Child(String name, String imageName, String status, String gender, int age, String state, Adult first, Adult second) {
	...
	public Child(String name, String imageName, String status, String gender, int age, String state) {
		// TODO Auto-generated constructor stub
		super(name, imageName, status, gender, age, state);
	}
